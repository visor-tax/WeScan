...
public protocol RectangleDetectionDelegateProtocol: NSObjectProtocol {
    ...
    /// Called when the autoscan progress is updated.
    /// - Parameters:
    ///   - captureSessionManager: The `CaptureSessionManager` that might autoscan.
    ///   - progress: The progress towards detecting an autoscan.
    func captureSessionManager(_ captureSessionManager: CaptureSessionManager, didUpdateAutoScanProgress progress: Float)
}
